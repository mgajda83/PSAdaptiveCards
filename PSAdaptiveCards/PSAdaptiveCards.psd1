#
# Module manifest for module 'PSAdaptiveCards'
#
...
@{
	...
	GUID = 'd940955a-5e0a-4d4e-9bd6-bbec3ba92878'
	...
	FunctionsToExport = @("Remove-NullProperties", "ConvertTo-ChatBotAttachment", "ConvertTo-GraphTeamsAttachment", "New-BaseMessage",
		...
		"New-FactSet", "New-Fact",
		"New-ImageSet", "New-Image",
		"New-Table", "New-TableColumn", "New-TableRow", "New-TableCell",
		"New-CodeBlock",
		"New-RichTextBlock", "New-TextRun",
		"New-TextBlock"
	)
	...
	PrivateData = @{
		...
		PSData = @{
			...
			ProjectUri = 'https://github.com/mgajda83/PSAdaptiveCards'
