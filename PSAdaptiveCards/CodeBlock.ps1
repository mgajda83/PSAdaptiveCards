...
class CodeBlock {
	...
	[String] $codeSnippet
	[nullable[CodeLanguage]] $language = "powershell"
	[Int] $startLineNumber = 1

	CodeBlock() {}
	CodeBlock([String]$CodeSnippet)
	{
		$this.codeSnippet = $codeSnippet
	}
	CodeBlock([hashtable]$Properties)
	{
...
Function New-CodeBlock
{
	...
	if($CodeSnippet) {
		$CodeBlock = [CodeBlock]::new($CodeSnippet)
	} elseif($Properties) {
		$CodeBlock = [CodeBlock]::new($Properties)
	} else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCChbyWvkMYURBlg
# DGVZN36y8nAKL0o2yW3zYJNCX7hHq6CCJmgwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# BgkqhkiG9w0BCQQxIgQgM1m1+AnbiSGdc2SqZ1NvHztCxyheHL4bROX5Lo9j0ZIw
# DQYJKoZIhvcNAQEBBQAEggIAjBfdOFHBhnuCNsvAzHxLdJYYRX71Xe38ZIJWlwq8
# Rs+EvmQSXp2Oj0h5nzdasOz7Ihv2mUtIQKMpTI6j/SQHJnMHgQ+mR0J09umCi5tH
# nQiKS6q3Yvz5CvCRf9jDVxI5s4gD7MBVcBfxow7oimRLOP/5ES7BEwb0YIIBX+g2
# g/Q3Q4W0T//DH9yUuZCWq7oJRuhI0PCqMcbTi9ji4cGAzvzzyeWhlYgb/wfCVT1W
# VtSMwGPpgNEHyLbt/rLGGlM71TOk1RbY0L/Goz49qUrguV3u1XtGcgpOL/ruAYQA
# Ycya6DT6D5NWJc3bN3tX1VZqTX830kLz+cM2OLgefP8IwryrQrMdqMdt/5hqSvGr
# tgZQZ/PEaNPFnQT/kknQF2U9oUUn9jjl38gyw/gwmfhASjurzyuvQ0DGFySK+/Kq
# k2d01vz5UPsL0jUds+sVCZz5+CQjd/07jqkM2d16PFOtC0WHlfP7Ygoge3KekubU
# PiMXjPxJnS/Dl1cWx9q0Fpgs2zfdc/xbDCH1BjTq8uAmKirfo2nLJc/wSxdBD5YA
# e5qDpV47wtZ1PUDry9TW/TBaBLUjHrOmaYr0qNVBwtf3ikR0tepp9dm3aaTPr8ps
# Slmiqz9dS3cmaULFPlz4WZPFAXmK8xq0nSaogNRhZfCzbkGT/+YsngIkkQza22jf
# 33+hggQEMIIEAAYJKoZIhvcNAQkGMYID8TCCA+0CAQEwazBWMQswCQYDVQQGEwJQ
...
# MTIEMKJpO10oziq8UPaezkXIyV5fzA5R/1wco+xr06xQKAV7g4kgzDA0SEDij39q
# /lJhsjCBoAYLKoZIhvcNAQkQAgwxgZAwgY0wgYowgYcEFMMluJsX/MUCYGHOK3F7
...
# MSBDQQIRAJ6cBPZVqLSnAm1JjGx4jaowDQYJKoZIhvcNAQEBBQAEggIAdy20s6fl
# zEEL5LXOB4gPrNboF/BD2bJUwu9A8CWSQq+8bRBEe8RQ+gSn6/NNIwuqxjG1N8sz
# rxr23ovhqgp9I9L2zuLdeTzsF5bCWI+DgxsqLoflPnm0ai3nTLpM2Q3554jqQg6x
# ejFMewkzVCE9+SsAeWj8wtydMKhZwC6trtRG73dDB+37Cqx3h8vnAZtN/hEY4FDE
# SNCnGrRfOqGmsbhGH6/ACvY2perpd2uz4tzw7GQ/EDr/gYJ9CuKqjfp4VqtaPD51
# Ezw0KvESREJyerjhdUe0XfRJY17ROdX9zwqe4uLsFGAM0y6G6oPc5sxjgvj40uVw
# 835gRxH9VFUHWZ/VaFQtsEUQ+gM3l7PEu4HmMkJP3dUtdv06pwZcasf1D7sfvWqf
# Ci3/P+e382viRd5eoUMw8kw/y3+nRTAqqelMlITP+9czaHuk8MSEIRmtqauM8DoX
# v4hIF8Qaen7bBRBkBVKHc4r2Lga/A6f7hrUNCtmPI6glzz+HmufbepD59Od9kjdm
# dv6rba6c/g9Z5ny8bUrFvEQJWOWizmTQ56Mq6AOPyYKUWx2bYyalU6uUQS/Iyajc
# NYJ39r7CsPl9lVN20ZvPcyxl2EGddkuEOCHccrhAVPQSRwgo+lUzEa33HOBF70iF
# Cyuh6jJrZqHmGSSfUilVhoNDCPYGefljn/4=
