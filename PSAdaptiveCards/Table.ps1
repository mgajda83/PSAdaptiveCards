...
class TableCell {
	...
	TableCell() {}
	TableCell([Hashtable]$Properties)
	{
...
class Table : Base {
	...
	[TableColumn[]] $columns
	[TableRow[]] $rows
	[nullable[Bool]] $firstRowAsHeader
	[nullable[Bool]] $showGridLines
	[nullable[ContainerStyle]] $gridStyle
	...
	Table([int]$Columns, [int]$Rows) {
		...
		#Define rows
		for ($i = 1; $i -le $Rows; $i++) {
			$this.rows += [TableRow]::new([int]$Columns)
		}
	}
	Table([Hashtable]$Properties)
	{
		foreach ($Property in $Properties.Keys) {
			$this.$Property = $Properties.$Property
		}
...
Function New-TableColumn
{
	...
	if($Properties) {
		$TableColumn = [TableColumn]::new($Properties)
	} else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6Dg5AXeTTimmW
# oguOn0dc6yiLa55dRzFhbqLoNBzhJaCCJmgwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# BgkqhkiG9w0BCQQxIgQgWExN41C0d2FtMm18+EreEsHfdx1q/hSb4Z+M21Yyb7ww
# DQYJKoZIhvcNAQEBBQAEggIAPN41itg9mJWpdBhVa0wLxwOJyXn832h9xZcGHpok
# DpVARs/ZEdA7hSQG66fr59vtCrrXzCs56t2gGPiSOdLv0aUZp/j7vgI0eWEZ2IT/
# OHvloG8m9c/ovENPtCNBXyWUSKJwBEsKkhskGG1UmtzGcZOsFN17zYLnVq4BygoQ
# dOLUEqFjwR8vnodn+pgrMBNa6CWvSgtNLs/Q9+5m9hKVuXBLeztCAlqtS61aLma8
# S5k/NS0bAwqVNLeQGoJcQ8K5+oHpN1BWZ1wniIu0HYGKpY4DYFFye9dvlgOSlhyD
# mZKNxwm5oblHZGAJPR01/aX5ziwi+G8seWlFrhC8e02sLD951y+WHCAG0Amwa64m
# ne3j84bbiyWqB0x3mtJdWQ0XLjkANAx6utvL2geKLom/54LKEyLIVzjhIyVlAA/x
# k8EIkWCD7DEOETTgPmpRPHwKM2Ux1Id0ANI4V0z1sRUxuYd6ObFMBHKa1Q3wTOZ2
# QFnyBFydZPky1le8mjwqNGT2uZxNV3/NVcR3bbKrIOZTnupHBslJev9Y4BUUr1O2
# Pvj7scJx2zrSJOCeL1UcnrKoYpi2IWLx0Th58K0mt5qXbfjNzBg5oi2p3SR3sOpB
# 9MZuELR0ZrdNmp7Gf4Uc/Ro+NRFJLYtHTdsTakmT+IyCNph9uystSCh1D0bq7vgc
# H9ihggQEMIIEAAYJKoZIhvcNAQkGMYID8TCCA+0CAQEwazBWMQswCQYDVQQGEwJQ
...
# KoZIhvcNAQkFMQ8XDTI1MDMxODA3NDQyMFowNwYLKoZIhvcNAQkQAi8xKDAmMCQw
# IgQgz6HcNZ3tK8PLiQ+iMOXa93tUDxpuKyPdzxdU4Yz6oNUwPwYJKoZIhvcNAQkE
# MTIEMBvMH/c3msQzCaVIkjjyAqglg9F1VTg34Nm6eXBW4dfjp/jaSRShV4eLTr63
# m7LqWjCBoAYLKoZIhvcNAQkQAgwxgZAwgY0wgYowgYcEFMMluJsX/MUCYGHOK3F7
...
# MSBDQQIRAJ6cBPZVqLSnAm1JjGx4jaowDQYJKoZIhvcNAQEBBQAEggIAnvNBbEg2
# GnuFPUDth9cXUqBFegYzqXAEY4zUXCs5bqNI1+uQ9RpUWynluQkak23zyT309cs/
# oQIr+DIxAhGG/yYt+R7huixglgYfMGLEOByz9VGL5KY6T5igEVEtsSDvTdysM39z
# +ufkMi4FMbLIzPyBUkzmXvNlo6Kz7WHHbQ0UG48iCNkdOEkw1cc3N8TTqgHqCLMp
# 2og7D0dHFbubPBtAJh3fbKxx0wMtaqA/zZQn7svGvh7Z8BDCunWC0xIDsXa+HHbl
# OJy+hzjXvOBDABbTsvz9iTA1M14I+XnnrBm8XAICCmOGzPBoWv1KvgBdthA8MxEK
# OGqEdnipd/rv/Y5Ojli47AOjOsY7k4rigRSh+c63vumBWEdn2oN2R8KAp5pC93rv
# wOi2+5243+AwdjuKBJluFxr71c/U/6n8jliMpPK8cRdTZHrO3b84gIwXok2kzPzD
# IxAxWTYdhHtfgt3PDcYaHRZJK6X2SRAYDl9cgy+1PDkH40dkLrqpMRxcCXThWwl8
# SjkMFP1EBsV+zUB2EEm8cbDeU7ZhBISsZyUKozjvVTZ3ojW+8Og4EmZeNmeb3GyW
# z9Z50Qa0Apfu1u56DerIAsYpq88kIeTi2gqECfUkl5WwypNhJlfc9MNvy+6f04eO
# nNK7b3R7Ml2VKWzrY2hDOk/+9ki5y/rudb0=
